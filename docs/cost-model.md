...
| Hosted showcase | Adds the isolated public-demo table/API/reset lane and its operations alarms. It remains request-priced but intentionally creates more resources and scheduled activity than a private team needs. |
